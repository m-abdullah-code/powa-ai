...
import { getClients } from '../api/chats';
import type { CreateClientData } from '../interface/chats';
import { setActiveEngagementId, setIsHistoryMode } from '../store/slices/chatSlice';
...
function Sidebar({ setIsOpen }: { isOpen?: boolean, setIsOpen?: (val: boolean) => void }) {
